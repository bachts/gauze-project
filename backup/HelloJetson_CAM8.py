...
net=jetson.inference.detectNet(argv=['--model=models/gauzejetsondataset_704by396/ssd-mobilenet.onnx', '--labels=models/gauzejetsondataset_704by396/labels.txt', '--input-blob=input_0', '--output-cvg=scores', '--output-bbox=boxes', '--threshold=0.3'])
...
while True:
    ...
    # Calculations to get the number of Gauze Left in play
    countGauzeLeft = countDetectedInput + countConfirmedInput - countDetectedOutput - countGauzeKept

    #NEW
    countGauzeIn = 10 - countDetectedInput
    countGauzeLeft = countDetectedOutput
    countGauzeInPlay = 10 - countDetectedInput - countDetectedOutput
...
#    cv2.putText(borderedFrame,"Detected Input: "+str(countDetectedInput),(38,120+height),font,1.5,(255,255,255),2)
#    cv2.putText(borderedFrame,"Confirmed Input: "+str(countConfirmedInput),(5,170+height),font,1.5,(255,255,255),2)
#    cv2.putText(borderedFrame,"Detected Output: "+str(countDetectedOutput),(width,120+height),font,1.5,(255,255,255),2)
#    cv2.putText(borderedFrame,"Gauze Left: "+str(countGauzeLeft),(130+width,170+height),font,1.5,(255,255,255),2)
#    cv2.putText(borderedFrame,"Gauze Kept: "+str(countGauzeKept),(115+width,220+height),font,1.5,(255,255,255),2)
...
#    cv2.putText(borderedFrame,"History: "+str(historyInput[-1]),(5,280+height),font,1,(180,180,180),2)
#    cv2.putText(borderedFrame,str(historyInput[-2]),(133+5,310+height),font,1,(180,180,180),2)
#    cv2.putText(borderedFrame,"History: "+str(historyOutput[-1]),(width,280+height),font,1,(180,180,180),2)
#    cv2.putText(borderedFrame,str(historyOutput[-2]),(133+width,310+height),font,1,(180,180,180),2)
