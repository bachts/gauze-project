...
#net=jetson.inference.detectNet(argv=['--model=models/1000gauzedataset_900by675/ssd-mobilenet.onnx', '--labels=models/1000gauzedataset_900by675/labels.txt', '--input-blob=input_0', '--output-cvg=scores', '--output-bbox=boxes', '--threshold=0.3'])
